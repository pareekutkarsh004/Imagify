...
function Navbar() {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
        ...
        <div>
          {/* we have to display two types of content in right side of navigation bar depending upon if the user is logged in or logged out  */}
          {
            user ?
             <div className='flex items-center gap-2 sm:gap-3'>
                ...
                <p className='text-gray-600 max-sm:hidden pl-4'>Hii, Utkarsh</p>
